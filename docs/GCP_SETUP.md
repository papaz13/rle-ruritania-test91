...
- Access to the GCP project (e.g., `rle-ruritania-test91`)
...
```bash
gcloud projects add-iam-policy-binding "rle-ruritania-test91" \
  --member="serviceAccount:github-actions-rle@rle-ruritania-test91.iam.gserviceaccount.com" \
...
```bash
gcloud projects describe rle-ruritania-test91 --format="value(projectNumber)"
```
...
gcloud iam service-accounts add-iam-policy-binding \
  "github-actions-rle@rle-ruritania-test91.iam.gserviceaccount.com" \
  --project="rle-ruritania-test91" \
...
| `GCP_SERVICE_ACCOUNT` | `github-actions-rle@rle-ruritania-test91.iam.gserviceaccount.com` |
...
```
Caller does not have required permission to use project rle-ruritania-test91.
